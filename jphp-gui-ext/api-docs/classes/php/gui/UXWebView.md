...
- **class** `UXWebView` (`php\gui\UXWebView`) **extends** [`UXParent`](https://github.com/jphp-group/jphp-gui-ext/blob/master/jphp-gui-ext/api-docs/classes/php/gui/UXParent.md)
- **package** `gui`
...
- `->`[`engine`](#prop-engine) : [`UXWebEngine`](https://github.com/jphp-group/jphp-gui-ext/blob/master/jphp-gui-ext/api-docs/classes/php/gui/UXWebEngine.md)
